            ...
            <LinearGradient colors={['#060812', '#0B101C', '#050711']} style={styles.container}>
                ...
                <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.contentWithButton}>
                    <Text style={styles.title}>
                        <Text style={styles.titleBlue}>Edit</Text> Task
                    </Text>
                    ...
                    <TextInput value="Study vocabulary" style={styles.input} />

                    <Text style={styles.inputLabelPink}>DESCRIPTION</Text>
                    <TextInput
                        multiline
                        value="Learn 10 new vocabulary words and review old ones."
                        style={[styles.input, styles.smallTextArea]}
                    />

                    <Text style={styles.inputLabelPink}>DURATION (M)</Text>
                    <TextInput value="30" keyboardType="numeric" style={styles.input} />
                    ...
                    <View style={styles.segmented}>
                        {recurrenceOptions.map((option) => (
                            <Pressable
                                key={option}
                                style={[styles.segmentItem, option === 'Daily' && styles.segmentActive]}
                            >
                                <Text style={[styles.segmentText, option === 'Daily' && styles.segmentTextActive]}>
                                    {option}
                                </Text>
                            </Pressable>
                        ))}
